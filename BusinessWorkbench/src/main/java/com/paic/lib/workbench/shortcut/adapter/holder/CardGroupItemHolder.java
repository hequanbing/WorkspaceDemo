 ...
 * @modify
 */
public class CardGroupItemHolder extends BaseShortcutHolder {
    private Context mContext;
    private TextView mGroupNameView;
    private ImageView mGroupLeftIcon;
    private GroupBean mData;

    public CardGroupItemHolder(Context context, View itemView) {
        super(context, itemView);
        this.mContext = context;
        mGroupNameView = itemView.findViewById(R.id.card_group_name);
        mGroupLeftIcon = itemView.findViewById(R.id.card_group_left_icon);
    }
